...
contract Child is Parent{
    ...
    function toBeOverridden() public pure virtual override returns(string memory){
        return "In Child";
    }
}
...
contract GrandChild is Child{
    function toBeOverridden() public pure virtual override returns(string memory){
        return "In GrandChild";
    }
}

contract GreatGrandChild is Child{
    function toBeOverridden() public pure override returns(string memory){
        return "In GreatGrandChild";
    }
}
